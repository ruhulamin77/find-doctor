            ...
            <Row lg={2} md={2} sm={1} xs={1}>
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p><i class="far fa-clock text-info"></i> 4 Oct 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 12 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
                ...
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p className="text-warning">Dr. Ruby Perrin</p>
                        <p><i class="far fa-clock text-info"></i> 8 Sep 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 16 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris ullamco laborisut aliquip ex ea commodo consequat. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo erty consequat. <Link to="" className="see-more">See more ...</Link> </p>
                ...
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p className="text-warning">Dr. Ruby Perrin</p>
                        <p><i class="far fa-clock text-info"></i> 5 Aug 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 52 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris ullamco laborisut aliquip ex ea commodo consequat. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo erty consequat. <Link to="" className="see-more">See more ...</Link> </p>
                ...
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p className="text-warning">Dr. Ruby Perrin</p>
                        <p><i class="far fa-clock text-info"></i> 1 Feb 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 22 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris ullamco laborisut aliquip ex ea commodo consequat. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo erty consequat. <Link to="" className="see-more">See more ...</Link> </p>
                ...
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p className="text-warning">Dr. Ruby Perrin</p>
                        <p><i class="far fa-clock text-info"></i> 31 Jan 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 11 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco sit laboris ullamco laborisut aliquip ex ea commodo consequat. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo erty consequat. <Link to="" className="see-more">See more ...</Link> </p>
                ...
                <Col>
                    ...
                    <div className="blog-info my-3">
                        ...
                        <p className="text-warning">Dr. Ruby Perrin</p>
                        <p><i class="far fa-clock text-info"></i> 1 Jan 2021 </p>
                        <p><i class="fas fa-comments text-info"></i> 18 Comments </p>
                        <p><i class="fas fa-tags text-info"></i> Health Tips </p>
                    </div>
