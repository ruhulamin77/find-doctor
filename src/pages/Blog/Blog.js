      ...
      <Row lg={2} md={2} sm={1} xs={1}>
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p>
              <i className="far fa-clock text-info"></i> 4 Oct 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 12 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
          </div>
          <p>
        ...
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p className="text-warning">Dr. Ruby Perrin</p>
            <p>
              <i className="far fa-clock text-info"></i> 8 Sep 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 16 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
        ...
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p className="text-warning">Dr. Ruby Perrin</p>
            <p>
              <i className="far fa-clock text-info"></i> 5 Aug 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 52 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
        ...
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p className="text-warning">Dr. Ruby Perrin</p>
            <p>
              <i className="far fa-clock text-info"></i> 1 Feb 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 22 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
        ...
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p className="text-warning">Dr. Ruby Perrin</p>
            <p>
              <i className="far fa-clock text-info"></i> 31 Jan 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 11 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
        ...
        <Col>
          ...
          <div className="blog-info my-3">
            ...
            <p className="text-warning">Dr. Ruby Perrin</p>
            <p>
              <i className="far fa-clock text-info"></i> 1 Jan 2021{' '}
            </p>
            <p>
              <i className="fas fa-comments text-info"></i> 18 Comments{' '}
            </p>
            <p>
              <i className="fas fa-tags text-info"></i> Health Tips{' '}
            </p>
